/*
################## Prod Server Maintenance Window ##################
############## Sunday Daily Backup/Maintenance only ##############
...
******Rowdy Vinson 8/29/14******
 ...
 - Full Recovery Mode databases are included in this
 - 1 minute SQL RPO
 - Disk space on V:\ for Full x4 + 48 Diffs + 2 days of logs
...
BEGIN
	...
	SET @JobName03 = 'DatabaseBackup - USER_DATABASES - DIFF'
	...
	SET @SchName03 = 'USER-DIFF BACKUPS'
	SET @SchName04 = 'USER-LOG BACKUPS'
...
--	SET @SchName07 = 'Test System CheckDB - Daily 8PM' --Shared with User DBs in Integrity Maintenance job
	...
	SELECT @SchFreqType01 = 8,      @SchFreqType02 = 4,      @SchFreqType03 = 4,      @SchFreqType04 = 4,      @SchFreqType05 = 4,      @SchFreqType06 = 8,      @SchFreqType07 = 8,      @SchFreqType08 = 8
	SELECT @SchFreqInt01  = 1,      @SchFreqInt02  = 1,      @SchFreqInt03  = 1,      @SchFreqInt04  = 1,      @SchFreqInt05  = 1,      @SchFreqInt06  = 1,      @SchFreqInt07  = 1,      @SchFreqInt08  = 1
	SELECT @SchSubType01  = 1,      @SchSubType02  = 1,      @SchSubType03  = 1,      @SchSubType04  = 4,      @SchSubType05  = 1,      @SchSubType06  = 1,      @SchSubType07  = 1,      @SchSubType08  = 1
	...
	SELECT @SchStart01    = 203000, @SchStart02    = 210000, @SchStart03    = 090000, @SchStart04    = 000000, @SchStart05    = 180000, @SchStart06    = 010000, @SchStart07    = 000000, @SchStart08    = 050000
...
--	Correct Job parameters from defaults
	...
	-- Keep Fulls for a week, Diffs for 2 days, Logs for 2 days--
	...
	EXEC dbo.sp_update_jobstep
		...
		@step_id = 1,
		@command=N'sqlcmd -E -S $(ESCAPE_SQUOTE(SRVR)) -d master -Q "EXECUTE [dbo].[DatabaseBackup] @Databases = ''USER_DATABASES'', @Directory = N''V:\Backup'', @BackupType = ''DIFF'', @Verify = ''Y'', @CleanupTime = 48, @CheckSum = ''Y'', @LogToTable = ''Y''" -b'
