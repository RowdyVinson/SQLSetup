/*
################## Test Server Maintenance Window ##################
############# Saturday Weekly Backup/Maintenance only ##############
...
******Rowdy Vinson 8/29/14******
 ...
 - Simple recovery model prefered, but Full is supported
 - Weekly SQL RPO
 - Disk space on V:\ for Full x2 + Logs x7days
...
--	SET @SchName07 = 'Test System CheckDB - Daily 8PM' --Shared with User DBs in Integrity Maintenance job
	...
	SELECT @SchFreqType01 = 8,      @SchFreqType02 = 8,      @SchFreqType03 = 8,      @SchFreqType04 = 4,      @SchFreqType05 = 8,      @SchFreqType06 = 8,      @SchFreqType07 = 8,      @SchFreqType08 = 8
	SELECT @SchFreqInt01  = 64,     @SchFreqInt02  = 64,     @SchFreqInt03  = 64,     @SchFreqInt04  = 1,      @SchFreqInt05  = 64,     @SchFreqInt06  = 64,     @SchFreqInt07  = 64,     @SchFreqInt08  = 64
	SELECT @SchSubType01  = 1,      @SchSubType02  = 1,      @SchSubType03  = 1,      @SchSubType04  = 1,      @SchSubType05  = 1,      @SchSubType06  = 1,      @SchSubType07  = 1,      @SchSubType08  = 1
	...
	SELECT @SchStart01    = 203000, @SchStart02    = 210000, @SchStart03    = 000000, @SchStart04    = 170000, @SchStart05    = 180000, @SchStart06    = 10000,  @SchStart07    = 000000, @SchStart08    = 50000
...
--	Correct Job parameters from defaults
	...
	EXEC dbo.sp_update_jobstep
		...
		@step_id = 1,
		@command=N'sqlcmd -E -S $(ESCAPE_SQUOTE(SRVR)) -d master -Q "EXECUTE [dbo].[DatabaseBackup] @Databases = ''USER_DATABASES'', @Directory = N''V:\Backup'', @BackupType = ''LOG'', @Verify = ''Y'', @CleanupTime = 168, @CheckSum = ''Y'', @LogToTable = ''Y''" -b'
